...
def populating_movies(request):
   ...
   # Populating movies table
    ...
    with connection.cursor() as cursor:
        ...
        cast_crew_file = open(
            'movies\Dbms_pro\current_movies_cast_crew.csv', 'r')
        cast_crew_reader = csv.reader(cast_crew_file)
        # cast_crew = []
        # for line in cast_crew_reader:
        #     if line[1] not in cast_crew:
        #         cast_crew.append(line[1])
        #         cursor.execute(''' insert ignore into movies_cast_crew(castname,image) values( %s , %s )  ''', [
        #                        line[1], line[2]])
        ...
        for line in cast_crew_reader:
            ...
            if a not in cast_crew_movie:
                ...
                cursor.execute(''' insert ignore into movies_cast_crew_movie(cast_crew_id,title_id) values( %s , %s )  ''', [
                               cast_id, title_id])
        ...
        #     if( lang.lower() not in already_inserted_languages  ):
        #         cursor.execute(''' insert ignore into movies_languages(language) values(%s)  ''',[lang])
        #         already_inserted_languages.append(lang.lower())
        ...
        #         cursor.execute(''' insert ignore into movies_language_movie(movie_language_id,title_id) values( %s , %s )  ''', [
        #                        lg_id, title_id])
        ...
        #         print(form)
        #         cursor.execute(
        #             ''' insert ignore into movies_formats(mformat) values(%s)  ''', [form])
        ...
        #         cursor.execute(''' insert ignore into movies_format_movie(movie_format_id,title_id) values( %s , %s )  ''', [
        #                        fr_id, title_id])
        ...
        #         cursor.execute(
        #             ''' insert ignore into movies_genre(genre) values(%s)  ''', [gen])
        ...
        #         gen_movie.append(a)
        #         cursor.execute(''' insert ignore into movies_genre_movie(movie_genre_id,title_id) values( %s , %s )  ''', [
        #                        gen_id, title_id])
        ...
        #     cursor.execute(''' insert ignore into movies_city_theatre(theatre_name,city_id) values( %s , %s )  ''', [
        #                    theatre_name, city_id])
        ...
        #         cursor.execute(''' insert ignore into movies_city_movie(city_id,movie_title_id) values( %s , %s )  ''', [
        #                        cr_id, title_id])
